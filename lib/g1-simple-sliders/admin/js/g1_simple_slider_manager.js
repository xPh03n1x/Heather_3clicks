(function (exports, $) {
    ...
    function handle_move_slide_up_down_action() {
        $(document).on('click', 'g1-simple-slide .g1-move-up', function(event){
        ...
        $(document).on('click', 'g1-simple-slide .g1-move-down', function(event){
            event.preventDefault();
    ...
    function handle_delete_slide_action() {
        $(document).on('click', 'g1-simple-slide .g1-delete-slide', function(event){
            event.preventDefault();
